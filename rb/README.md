# WeatherDataApi3 Ruby SDK



The Ruby SDK for the WeatherDataApi3 API — an entity-oriented client using idiomatic Ruby conventions.
...
```ruby
client = WeatherDataApi3SDK.test(testopts, sdkopts)
```
...
raise a `WeatherDataApi3Error` (a `StandardError` subclass), so wrap
...
```
rb/
├── WeatherDataApi3_sdk.rb       -- Main SDK module
...
The main module (`WeatherDataApi3_sdk`) exports the SDK class
