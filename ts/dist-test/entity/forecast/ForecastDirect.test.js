...
(0, node_test_1.describe)('ForecastDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.WeatherDataApi3SDK({
    ...
    (0, node_test_1.test)('direct-load-forecast', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-forecast', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.WeatherDataApi3SDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['WEATHER_DATA_API3_TEST_FORECAST_ENTID'];
    ...
    const client = new __1.WeatherDataApi3SDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ForecastDirect.test.js.map