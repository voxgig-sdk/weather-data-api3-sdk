...
class WeatherDataApi3TestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WeatherDataApi3TestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = WeatherDataApi3TestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = WeatherDataApi3TestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
