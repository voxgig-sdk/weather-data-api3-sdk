...
from projectname_sdk import WeatherDataApi3SDK
from projectname_sdk.core.spec import WeatherDataApi3Spec
from projectname_sdk.core.result import WeatherDataApi3Result
from projectname_sdk.core.response import WeatherDataApi3Response
from projectname_sdk.core.operation import WeatherDataApi3Operation
from projectname_sdk.core.error import WeatherDataApi3Error
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import WeatherDataApi3BaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return WeatherDataApi3Error(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except WeatherDataApi3Error as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = WeatherDataApi3Result({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = WeatherDataApi3SDK.test(None, None)
        ...
        class TestInitFeature(WeatherDataApi3BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(WeatherDataApi3BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = WeatherDataApi3SDK({
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = WeatherDataApi3SDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = WeatherDataApi3Spec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = WeatherDataApi3SDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = WeatherDataApi3Operation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = WeatherDataApi3SDK.test(None, setup_opts)
