...
// WeatherDataApi3 SDK metrics feature
...
class WeatherDataApi3MetricsFeature extends WeatherDataApi3BaseFeature
{
    ...
    private function _record(WeatherDataApi3Context $ctx, bool $ok): void
    {
