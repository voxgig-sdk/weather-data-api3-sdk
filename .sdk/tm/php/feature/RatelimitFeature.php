...
// WeatherDataApi3 SDK ratelimit feature
...
class WeatherDataApi3RatelimitFeature extends WeatherDataApi3BaseFeature
{
    ...
    private function _acquire(WeatherDataApi3Context $ctx): void
    {
    ...
    private function _track(WeatherDataApi3Context $_ctx, float $wait_ms): void
    {
        $client = $this->client;
