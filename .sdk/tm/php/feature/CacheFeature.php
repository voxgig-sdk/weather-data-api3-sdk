...
// WeatherDataApi3 SDK cache feature
...
class WeatherDataApi3CacheFeature extends WeatherDataApi3BaseFeature
{
    ...
    private function _through(WeatherDataApi3Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
