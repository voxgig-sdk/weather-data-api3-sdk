...
// WeatherDataApi3 SDK proxy feature
...
class WeatherDataApi3ProxyFeature extends WeatherDataApi3BaseFeature
{
    ...
    public function init(WeatherDataApi3Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (WeatherDataApi3Context $ctx2, string $url2, array $fetchdef) use ($inner): array {
