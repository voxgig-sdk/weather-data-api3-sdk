...
// WeatherDataApi3 SDK rbac feature
...
class WeatherDataApi3RbacFeature extends WeatherDataApi3BaseFeature
{
    ...
    private function _required(WeatherDataApi3Context $ctx): ?string
    {
    ...
    private function _reject(WeatherDataApi3Context $ctx, string $required): void
    {
    ...
    private function _track(WeatherDataApi3Context $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
