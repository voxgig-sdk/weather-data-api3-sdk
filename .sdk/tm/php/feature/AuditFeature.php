...
// WeatherDataApi3 SDK audit feature
...
class WeatherDataApi3AuditFeature extends WeatherDataApi3BaseFeature
{
    ...
    private function _emit(WeatherDataApi3Context $ctx, string $outcome): void
    {
