...
// WeatherDataApi3 SDK streaming feature
...
class WeatherDataApi3StreamingFeature extends WeatherDataApi3BaseFeature
{
    ...
    private function _iterate(WeatherDataApi3Result $result): \Generator
    {
    ...
    private function _streamable(WeatherDataApi3Context $ctx): bool
    {
