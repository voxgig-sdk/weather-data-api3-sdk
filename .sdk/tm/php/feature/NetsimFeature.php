...
// WeatherDataApi3 SDK netsim feature
...
class WeatherDataApi3NetsimFeature extends WeatherDataApi3BaseFeature
{
    ...
    private function _simulate(WeatherDataApi3Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(WeatherDataApi3Context $ctx, array $applied): void
    {
        $client = $this->client;
