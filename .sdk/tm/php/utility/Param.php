...
// WeatherDataApi3 SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class WeatherDataApi3Param
{
    public static function call(WeatherDataApi3Context $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = WeatherDataApi3Helpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
