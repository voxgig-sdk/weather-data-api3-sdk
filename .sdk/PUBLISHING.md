...
|---|---|---|
| `ts/` | @voxgig-sdk/weather-data-api3-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/weather-data-api3-sdk \
      --repository voxgig-sdk/weather-data-api3-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/weather-data-api3-sdk` shows it, and
`npm trust revoke @voxgig-sdk/weather-data-api3-sdk --id=<id>` removes it.
