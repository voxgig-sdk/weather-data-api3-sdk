...
// WeatherDataApi3 SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class WeatherDataApi3TestFeature extends WeatherDataApi3BaseFeature
{
    ...
    public function init(WeatherDataApi3Context $ctx, array $options): void
    {
        ...
        $test_fetcher = function (WeatherDataApi3Context $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = WeatherDataApi3Param::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (WeatherDataApi3Context $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(WeatherDataApi3Context $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = WeatherDataApi3Param::call($ctx, $k);
