...
// WeatherDataApi3 SDK timeout feature
...
class WeatherDataApi3TimeoutFeature extends WeatherDataApi3BaseFeature
{
    ...
    private function _with_timeout(WeatherDataApi3Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(WeatherDataApi3Context $_ctx, float $ms): void
    {
        $client = $this->client;
