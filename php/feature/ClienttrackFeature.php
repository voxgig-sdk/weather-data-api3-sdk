...
// WeatherDataApi3 SDK clienttrack feature
...
class WeatherDataApi3ClienttrackFeature extends WeatherDataApi3BaseFeature
{
    ...
    public function PostConstruct(WeatherDataApi3Context $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'WeatherDataApi3-SDK';
