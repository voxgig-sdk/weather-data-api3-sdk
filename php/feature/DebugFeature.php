...
// WeatherDataApi3 SDK debug feature
...
class WeatherDataApi3DebugFeature extends WeatherDataApi3BaseFeature
{
    ...
    private function _finish(WeatherDataApi3Context $ctx, bool $ok): void
    {
