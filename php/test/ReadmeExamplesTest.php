...
// WeatherDataApi3 SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (WeatherDataApi3SDK::test)
...
{
    private const SDK_CLASS = 'WeatherDataApi3SDK';
    ...
    private const SDK_BASE = 'weatherdataapi3_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../weatherdataapi3_sdk.php';
