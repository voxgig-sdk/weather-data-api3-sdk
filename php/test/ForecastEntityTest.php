...
class ForecastEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set WEATHERDATAAPI__TEST_FORECAST_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function forecast_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("WEATHERDATAAPI__TEST_FORECAST_ENTID");
