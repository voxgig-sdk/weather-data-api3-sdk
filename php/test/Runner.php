...
class WeatherDataApi3TestRunner
{
    ...
    {
        $live = self::getenv('WEATHER_DATA_API3_TEST_LIVE');
        $override = self::getenv('WEATHER_DATA_API3_TEST_OVERRIDE');
        ...
        $explain = self::getenv('WEATHER_DATA_API3_TEST_EXPLAIN');
...
class_alias('WeatherDataApi3TestRunner', 'Runner');
class_alias('WeatherDataApi3Helpers', 'Helpers');
