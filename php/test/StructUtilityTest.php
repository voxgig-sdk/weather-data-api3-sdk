...
// WeatherDataApi3 SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = WeatherDataApi3Omni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(WeatherDataApi3Omni::structfix($now, Struct::undef()))
                        !== json_encode(WeatherDataApi3Omni::structfix($val, Struct::undef()))) {
