...
// WeatherDataApi3 SDK pipeline test
//
...
{
    private static function utility(): WeatherDataApi3Utility
    {
        return new WeatherDataApi3Utility();
    }
    ...
    private static function ctx(array $over = []): WeatherDataApi3Context
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new WeatherDataApi3Context([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new WeatherDataApi3Operation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof WeatherDataApi3Error) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new WeatherDataApi3Operation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = WeatherDataApi3MakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new WeatherDataApi3Operation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = WeatherDataApi3MakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new WeatherDataApi3Operation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = WeatherDataApi3MakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new WeatherDataApi3Spec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = WeatherDataApi3MakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        ...
        [, $err] = WeatherDataApi3MakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new WeatherDataApi3Spec([]),
            'response' => null,
            'result' => new WeatherDataApi3Result([]),
        ]);
        [, $err] = WeatherDataApi3MakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new WeatherDataApi3Spec(['step' => 's']),
            'response' => new WeatherDataApi3Response(self::resp(404, null, ['x-a' => '1'])),
            'result' => new WeatherDataApi3Result([]),
        ]);
        [, $err] = WeatherDataApi3MakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new WeatherDataApi3Spec(['step' => 's']),
            'response' => new WeatherDataApi3Response(self::resp(200, ['v' => 1])),
            'result' => new WeatherDataApi3Result([]),
        ]);
        [, $err] = WeatherDataApi3MakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new WeatherDataApi3Spec(['step' => 's']),
            'response' => new WeatherDataApi3Response(self::resp(200, ['v' => 2])),
            'result' => new WeatherDataApi3Result([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        WeatherDataApi3MakeResponse::call($ctx);
    ...
    {
        $preset = new WeatherDataApi3Response(self::resp(299));
        $ctx = self::ctx([
            'spec' => new WeatherDataApi3Spec([]),
            'response' => new WeatherDataApi3Response([]),
            'result' => new WeatherDataApi3Result([]),
        ...
        [$got, $err] = WeatherDataApi3MakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new WeatherDataApi3Result([])]);
        [, $err] = WeatherDataApi3MakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new WeatherDataApi3Spec([]), 'result' => null]);
        [, $err] = WeatherDataApi3MakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new WeatherDataApi3Spec(['step' => 's']),
            'result' => new WeatherDataApi3Result(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new WeatherDataApi3Operation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = WeatherDataApi3MakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new WeatherDataApi3Spec(['step' => 's']),
            'result' => new WeatherDataApi3Result(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new WeatherDataApi3Operation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = WeatherDataApi3MakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new WeatherDataApi3Result(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new WeatherDataApi3Spec([]),
            'result' => new WeatherDataApi3Result([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = WeatherDataApi3MakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = WeatherDataApi3MakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new WeatherDataApi3Error('boom', 'boom');
        $utility->fetcher = function (WeatherDataApi3Context $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new WeatherDataApi3Spec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = WeatherDataApi3MakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (WeatherDataApi3Context $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = WeatherDataApi3MakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(WeatherDataApi3Response::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        WeatherDataApi3MakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (WeatherDataApi3Context $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new WeatherDataApi3Spec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = WeatherDataApi3MakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new WeatherDataApi3Response(self::resp(201));
        $ctx = self::ctx(['spec' => new WeatherDataApi3Spec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = WeatherDataApi3MakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = WeatherDataApi3MakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = WeatherDataApi3MakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new WeatherDataApi3Result(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, WeatherDataApi3Done::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new WeatherDataApi3Result(['ok' => false])]);
        $this->expectException(WeatherDataApi3Error::class);
        WeatherDataApi3Done::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new WeatherDataApi3Result(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', WeatherDataApi3MakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        WeatherDataApi3MakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new WeatherDataApi3BaseFeature();
        $b = new WeatherDataApi3BaseFeature();
        WeatherDataApi3FeatureAdd::call($ctx, $a);
        WeatherDataApi3FeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): WeatherDataApi3BaseFeature
    {
        $f = new WeatherDataApi3BaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        WeatherDataApi3FeatureAdd::call($ctx, self::named_feature('a'));
        WeatherDataApi3FeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        WeatherDataApi3FeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        WeatherDataApi3FeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        WeatherDataApi3FeatureAdd::call($ctx, $replace);
        ...
        WeatherDataApi3FeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): WeatherDataApi3Context
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new WeatherDataApi3Spec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = WeatherDataApi3PrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        WeatherDataApi3PrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new WeatherDataApi3Response(['headers' => null]),
            'result' => new WeatherDataApi3Result([]),
        ]);
        WeatherDataApi3ResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        WeatherDataApi3ResultBody::call($ctx);
