...
// WeatherDataApi3 SDK utility type

class WeatherDataApi3Utility
{
    ...
    public static function copy(WeatherDataApi3Utility $src): WeatherDataApi3Utility
    {
        $u = new WeatherDataApi3Utility();
        $u->clean = $src->clean;
        $u->done = $src->done;
