...
// WeatherDataApi3 SDK utility: graphql
//
...
class WeatherDataApi3Graphql
{
    ...
    // equivalent.
    public static function body(WeatherDataApi3Context $ctx): mixed
    {
    ...
    public static function errors(WeatherDataApi3Context $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
