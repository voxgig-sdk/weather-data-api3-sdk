...
// WeatherDataApi3 SDK utility: fetcher

class WeatherDataApi3Fetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; WeatherDataApi3SDK/1.0)';
    ...
    public static function call(WeatherDataApi3Context $ctx, string $fullurl, array $fetchdef): array
    {
