...
func registerSDKWords(r *eng.Registry, client *sdk.WeatherDataApi3SDK) {
...
func runOp(client *sdk.WeatherDataApi3SDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
