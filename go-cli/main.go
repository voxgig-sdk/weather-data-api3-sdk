// Command WeatherDataApi3-cli is a CLI + REPL for the WeatherDataApi3 SDK,
...
const prompt = "weather-data-api3"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      WEATHER_DATA_API3_APIKEY (api key), WEATHER_DATA_API3_BASE (base url override)")
