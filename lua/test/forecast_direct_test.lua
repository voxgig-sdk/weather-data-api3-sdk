...
describe("ForecastDirect", function()
  it("should direct-load-forecast", function()
    local setup = forecast_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-forecast", setup.live and "live" or "unit")
