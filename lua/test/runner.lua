...
function runner.env_override(m)
  local live = runner.getenv("WEATHERDATAAPI3_TEST_LIVE")
  local override = runner.getenv("WEATHERDATAAPI3_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("WEATHERDATAAPI3_TEST_EXPLAIN")
