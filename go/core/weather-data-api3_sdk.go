...
import (
	...
	vs "github.com/voxgig-sdk/weather-data-api3-sdk/go/utility/struct"
)

type WeatherDataApi3SDK struct {
	Mode     string
...
func (sdk *WeatherDataApi3SDK) OptionsMap() map[string]any {
...
func (sdk *WeatherDataApi3SDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *WeatherDataApi3SDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *WeatherDataApi3SDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WeatherDataApi3SDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *WeatherDataApi3SDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *WeatherDataApi3SDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("WeatherDataApi3SDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *WeatherDataApi3SDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WeatherDataApi3SDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("WeatherDataApi3SDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *WeatherDataApi3SDK {
	...
	sdk := NewWeatherDataApi3SDK(sdkopts)
	sdk.Mode = "test"
