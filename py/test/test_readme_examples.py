# WeatherDataApi3 SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions WeatherDataApi3SDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both WeatherDataApi3SDK(...) and WeatherDataApi3SDK.test(...) become
#      WeatherDataApi3SDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "weatherdataapi3_sdk"
_SDK_CLASS = "WeatherDataApi3SDK"
