...
The Python SDK for the WeatherDataApi3 API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/weather-data-api3-sdk/releases)) or
