...
from weatherdataapi3_sdk.core.control import WeatherDataApi3Control
...
from weatherdataapi3_sdk.core.helpers import get_ctx_prop, to_map
...
class WeatherDataApi3Context:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = WeatherDataApi3Control()
        ...
        if isinstance(sp, WeatherDataApi3Spec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, WeatherDataApi3Result):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, WeatherDataApi3Response):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return WeatherDataApi3Operation({})
    ...
    def make_error(self, code, msg):
        return WeatherDataApi3Error(code, msg, self)
