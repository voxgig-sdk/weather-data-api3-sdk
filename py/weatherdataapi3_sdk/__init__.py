...
from weatherdataapi3_sdk.utility import register

# Load features
from weatherdataapi3_sdk.feature.base_feature import WeatherDataApi3BaseFeature
from weatherdataapi3_sdk.features import _has_feature, _make_feature
...
class WeatherDataApi3SDK:
    ...
    def get_utility(self):
        return WeatherDataApi3Utility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("WeatherDataApi3SDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Forecast(self, data=None) -> "ForecastEntity":
        ...
        from weatherdataapi3_sdk.entity.forecast_entity import ForecastEntity
