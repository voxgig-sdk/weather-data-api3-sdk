...
from weatherdataapi3_sdk.weatherdataapi3_types import (
    Forecast,
    ForecastLoadMatch,
)
...
class ForecastEntity:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Forecast:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Forecast().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
