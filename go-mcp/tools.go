...
func registerTools(server *mcp.Server, client *sdk.WeatherDataApi3SDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "weather-data-api3_list",
		Description: "List records from WeatherDataApi3. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "weather-data-api3_load",
		Description: "Load a single record from WeatherDataApi3. " +
...
func runOp(client *sdk.WeatherDataApi3SDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.WeatherDataApi3SDK, name string) (sdk.WeatherDataApi3Entity, error) {
